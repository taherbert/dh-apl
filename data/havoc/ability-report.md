...
Generated from SimC midnight branch. 229 spells, 80 modifier sources.
...
School: Physical | GCD: 1.5s | CD: 120s | Range: 40yd
AoE: 5yd radius
Haste scales: gcd
...
**Row 10:**
- (2) **Eternal Hunt** (1270898) [active_ability]
- (2) **Eternal Hunt** (1270900) [active_ability]
- (2) **Eternal Hunt** (1270901) [active_ability]
  → Eye Beam (cooldown_modifier)
  → Furious Gaze (cooldown_modifier)
  → Eternal Hunt (cooldown_modifier)
  → Cycle of Hatred (cooldown_modifier)
...
- (2) **Demonsurge** (452402) [passive_buff]
  _Metamorphosis now also $?a212612[causes Demon Blades to generate $162264s10 additional Fury][greatly empowers Voidblade and Hungering Slash]. While demon form is active, the first cast of each empower..._
...
- (3) **Improved Soul Rending** (452407) [passive]
  ...
  _Leech granted by Soul Rending increased by $s1% and an additional $s2% while Metamorphosis is active._
...
- (2) **Demonic Intensity** (452415) [passive_buff]
  _Activating Metamorphosis greatly empowers $?a212612[Eye Beam, Immolation Aura][The Hunt]. $?a212612[Demonsurge][Voidsurge] damage is increased by $?a212612[${$452416s2}][${$1246160s2}]% for each time ..._
