...
Provides pseudo-expressions for all otherwise omitted Assisted Combat rules due to being implicit checks as a part of `action_t::ready()`.

Requires some combination of sim-scope or player-scope save options.
```
